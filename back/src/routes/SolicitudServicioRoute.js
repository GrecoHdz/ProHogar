...
router.put("/:id", [
    ...
    body("estado").optional().isIn(["pendiente_pagovisita","pendiente_cotizacion","pendiente_asignacion","verificando_pagovisita", "verificando_pagoservicio", "asignado", "en_proceso", "finalizado", "calificado", "pendiente_pagoservicio","cancelado"]).withMessage("Estado no válido"),
